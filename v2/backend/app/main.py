...
from app.routers import generate, novel, export, chat, prompts, model_config, refine
...
app = FastAPI(title="番茄小说生成智能体 V2", version="v2.0.0", lifespan=lifespan)
...
@app.get("/")
async def root():
    return {"message": "番茄小说生成智能体 V2 API", "version": "v2.0.0", "status": "running"}
