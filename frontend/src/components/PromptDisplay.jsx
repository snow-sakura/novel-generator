...
export default function PromptDisplay({ gender = '男频', genre = '都市脑洞', style = '轻松搞笑' }) {
  ...
  const tabs = Object.entries(DEFAULT_PROMPTS)
  ...
  return (
    <div className="bg-gray-50 rounded-xl border border-gray-200 overflow-hidden">
      ...
      <div className="p-3">
        ...
        <pre className="text-xs text-gray-700 leading-relaxed whitespace-pre-wrap font-mono bg-white p-3 rounded-lg border border-gray-100 max-h-48 overflow-y-auto">
          {tabs.find(([k]) => k === activeTab)?.[1].content || ''}
        </pre>
      </div>
    </div>
  )
