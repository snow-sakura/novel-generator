...
app = FastAPI(title="番茄小说生成智能体 V1", version="v1.3.1", lifespan=lifespan)
...
async def backup_database():
    ...
    backup_path = os.path.join(backup_dir, f"novel_generator_v1_{ts}.db")
