...
export default function NovelReader({ novelId = undefined, initialContent = undefined, initialChapters = undefined, onContentChange = undefined, onInsertContent = undefined, simple = false }: { novelId?: number | string; initialContent?: string; initialChapters?: Array<{ title: string; index: number }>; onContentChange?: (text: string, chapterIndex: number, paragraphIndex: number) => void; onInsertContent?: (text: string, chapterIndex: number, position: 'before' | 'after') => void; simple?: boolean }) {
