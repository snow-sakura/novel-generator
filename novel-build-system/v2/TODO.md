...
- **版本历史管理**：记录段落修改历史，支持版本对比
- **生成记录管理增强**：支持分页/轮询/继续/取消，状态追踪更完善

### 优化改进

- **前端UI优化**：章节目录改进、生成状态追踪增强
...
| 文件 | 说明 |
|---|---|
| `v2/frontend/src/pages/NovelPage.jsx` | 新增段落润色、版本历史功能 |
| `v2/frontend/src/components/RefineModal.jsx` | 新增段落润色弹窗组件 |
| `v2/backend/app/routers/refine.py` | 新增段落润色API |
