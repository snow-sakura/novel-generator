...
import { ChevronUp, PenLine, RefreshCw, Expand, Minimize2, History, Check, Loader2, ChevronDown } from 'lucide-react'
import { useNovelStore } from '../stores/novelStore'
import { refineParagraph, fetchParagraphVersions } from '../services/api'
...
function RefineSidebar({ selectedParagraph, novelId, onClose, onApply, onRefresh }) {
...
export default function NovelReader({ novelId, initialContent, initialChapters, onContentChange, simple }) {
