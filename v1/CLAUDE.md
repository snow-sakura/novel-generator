# CLAUDE.md — 番茄小说生成智能体 V1

## 项目概述

番茄小说生成智能体 V1（Tomato Novel Generator V1）—— 一句话输入，AI 自动生成完整小说。
支持风格多选、六层大纲、CrewAI 多智能体管线、XMind 导出、对话式创作。

> **版本标识**: 本目录为 V1 骨架版，API 前缀 `/api/v1`，数据库文件 `novel_generator_v1.db`
...
2. 前端调用 `POST /api/v1/records/{id}/cancel` → 后端标记 `cancelled`
