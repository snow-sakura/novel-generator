...
import { ChevronUp, PenLine, RefreshCw, Expand, Minimize2, History, Check, Loader2, ChevronDown, Quote, Plus, Send, Wand2 } from 'lucide-react'
...
function RefineSidebar({ selectedParagraph, novelId, onClose, onApply, onInsertContent, onRefresh,
...
export default function NovelReader({ novelId, initialContent, initialChapters, onContentChange, onInsertContent, simple }) {
